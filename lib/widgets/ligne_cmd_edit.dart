...
import '../providers/cmd_provider.dart';
...
class _LigneCmdEditState extends State<LigneCmdEdit> {
                      ...
                      children: [
                        Visibility(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                updateLigneC(context, cmdProvider);
                              },
  ...
  Future updateLigneC(context,CmdProvider cmdProvider) async {
    ...
    updateCmdStatus(widget.ligneC.a_bcc_nupi, cmdProvider, false, StatusConstants.EN_PREPARATION);
  }
